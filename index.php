          ...
          <div class="col-sm-12">
            <div class="jumbotron text-center text-block" style="padding-top:170px;">
              <img src="images/Vote.png" alt="">
                  ...
                  <a href="user.php" class="btn btn-primary btn-md specialHead"> <span class="glyphicon glyphicon-tag"></span> Choose Your Vote</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-sm-12 text-center">
            <div class="page-header" style="padding-top:50px;padding-bottom:50px">
              ...
              <p class="subFont" style="font-size:20px;"><em>Online voting – or e-voting – makes use of the Internet, SMS, or other digital services in order to cast a democratic vote.</em></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="conatiner" style="padding:50px;" id="aboutTab">
        <div class="row">
          ...
          <div class="col-sm-4 text-center">
            ...
            <img src="image/online voting.png" width="100" height="100" alt=""/>
          ...
          <div class="col-sm-4 text-center">
            ...
            <img src="image/Vote.png" width="100" height="100" alt=""/>
          ...
          <div class="col-sm-4 text-center"> 
            ...
            <img src="image/statitics.jpg" width="100" height="100" alt=""/>
          ...
          <div class="row">
            <div class="col-sm-12 text-center" style="">
              <div class="page-header" style="padding-top:30px;padding-bottom:30px;">
                <img src="image/contact.jpg" width="100" height="100" alt="">
                <br>
